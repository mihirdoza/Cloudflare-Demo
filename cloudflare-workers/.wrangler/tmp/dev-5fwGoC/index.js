...
app.post("/manufacturer", async (c) => {
  try {
    ...
    const queryCondition = condition || "OR";
...
app.post("/equipment", async (c) => {
  try {
    ...
    console.error("Error details:", error3.stack || error3.message || error3);
    return c.json({ error: "Server error. Check logs for details." }, 500);
  }
});
...
// .wrangler/tmp/bundle-eW47kB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eW47kB/middleware-loader.entry.ts
