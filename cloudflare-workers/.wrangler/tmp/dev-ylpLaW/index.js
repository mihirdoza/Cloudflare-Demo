...
function buildQuery(search, condition = "AND") {
  if (!search) {
    return {
...
app.get("/", async (c) => {
  try {
    ...
    console.error("Error checking DB:", error3);
...
// .wrangler/tmp/bundle-fKt1Fj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-fKt1Fj/middleware-loader.entry.ts
